<?php
class Doctor_Service_SqlDatabase_PostgreSql_PgsqlDriver 
implements
    Doctor_Service_SqlDatabase_PostgreSql_DriverInterface
{
    ...
    // Doctor_Service_SqlDatabase_PostgreSql_DriverInterface: START -----------
    ...
    // Doctor_Service_SqlDatabase_PostgreSql_DriverInterface: END -----------
    ...
    private function connect() {
        ...
        if ($this->connection === false) {
            throw new Doctor_Service_SqlDatabase_Exception_ConnectionFailed(pg_last_error());
        }
