<?php
class Doctor_Service_SqlDatabase_PostgreSql_Adapter 
implements
    Doctor_Service_Interface_SqlDatabase
{
    ...
    /**
     * Драйвер базы данных
     * @var Doctor_Service_SqlDatabase_PostgreSql_DriverInterface 
     */
    private $driver;
     ...
     * @param Doctor_Service_SqlDatabase_PostgreSql_DriverInterface $driver драйвер базы данных
    ...
    public function __construct(
        Doctor_Service_SqlDatabase_PostgreSql_DriverInterface $driver,
