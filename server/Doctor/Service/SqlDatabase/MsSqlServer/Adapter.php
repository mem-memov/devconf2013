<?php
class Doctor_Service_SqlDatabase_MsSqlServer_Adapter 
implements
    Doctor_Service_Interface_SqlDatabase
{
    ...
    /**
     * Драйвер базы данных
     * @var Doctor_Service_SqlDatabase_MsSqlServer_DriverInterface
     */
    private $driver;
     ...
     * @param Doctor_Service_SqlDatabase_MsSqlServer_DriverInterface $driver драйвер базы данных
    ...
    public function __construct(
        Doctor_Service_SqlDatabase_MsSqlServer_DriverInterface $driver,
