<?php
class Doctor_Service_SqlDatabase_MsSqlServer_MssqlDriver 
implements
    Doctor_Service_SqlDatabase_MsSqlServer_DriverInterface
{
    ...
    private function connect() {
        ...
        if ($this->connection === false) {
            throw new Doctor_Service_SqlDatabase_Exception_ConnectionFailed(mssql_get_last_message());
        }

        $databaseSelected = mssql_select_db($this->database, $this->connection);

        if (!$databaseSelected) {
            throw newDoctor_Service_SqlDatabase_Exception_ConnectionFailed(mssql_get_last_message());
        }
