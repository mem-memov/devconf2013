...
class Doctor_ExtDirect_Input {
    ...
    public function initialize(
        ...
        if (
            ...
            throw new Doctor_ExtDirect_Exception('Повторная инициализация запроса невозможна.');
        }
     ...
     * @param Doctor_ExtDirect_Factory_Request $requestFactory
     * @return Doctor_ExtDirect_Request_Form
     */
    public function fetchFormRequest(Doctor_ExtDirect_Factory_Request $requestFactory) {
     ...
     * @link http://www.sencha.com/products/extjs/extdirect
     * @param Doctor_ExtDirect_Factory_Request $rrequestFactory
     * @return array
     */
    public function fetchBatchRequests(Doctor_ExtDirect_Factory_Request $rrequestFactory) {
